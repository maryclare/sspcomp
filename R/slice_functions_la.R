...
#' @param Omega.half A length(dim(X)) - 1 list of symmetric square roots of covariance matrices for the normal vectors z used in defining priors for penalized regression coefficients. Null values indicate that a prior distribution is assumed for the corresponding covariance matrix. If the first element is NULL, a constrained covariance matrix (AR-1 by default or SAR if explicitly specified) is assumed. Defaults to a list of NULL values.
#' @param Psi.half A length(dim(X)) - 1 list of symmetric square roots of covariance matrices for scales under the SPN prior for penalized regression coefficients. When the SPN prior is used, null values indicate that a prior distribution is assumed for the corresponding covariance matrix. If the first element is NULL, a constrained covariance matrix (AR-1 by default or SAR if explicitly specified) is assumed. Defaults to a list of NULL values.
...
#' @param pr.xi.omega.a A scalar corresponding to the first shape parameter of the beta prior assumed for the SAR parameter for the first covariance matrix for the normal vectors z used in defining priors for penalized regression coefficients (when the first covariance matrix is not provided). Defaults to 1.
#' @param pr.xi.omega.b A scalar corresponding to the second shape parameter of the beta prior assumed for the SAR parameter for the first covariance matrix for the normal vectors z used in defining priors for penalized regression coefficients (when the first covariance matrix is not provided). Defaults to 1.
#' @param pr.xi.psi.a A scalar corresponding to the first shape parameter of the beta prior assumed for the SAR parameter for the first covariance matrix for the scales under the SPN prior (when the first covariance matrix is not provided). Defaults to 1.
#' @param pr.xi.psi.b A scalar corresponding to the second shape parameter of the beta prior assumed for the SAR parameter for the first covariance matrix for the scales under the SPN prior (when the first covariance matrix is not provided). Defaults to 1.
